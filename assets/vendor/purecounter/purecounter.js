        ...
        return t = e, (n = [{
            key: "registerEventListeners", value: function () {
                ...
                if (this.intersectionListenerSupported()) for (var n = new IntersectionObserver(this.animateElements.bind(this), {
                    ...
                    rootMargin: "20px",
                    threshold: .5
                }), r = 0; r < t.length; r++) n.observe(t[r]); else window.addEventListener && (this.animateLegacy(t), window.addEventListener("scroll", function (n) {
                    e.animateLegacy(t)
                }, {passive: !0}))
            }
        }, {
            ...
            key: "nextNumber", value: function (e, t, n, r) {
            ...
            key: "castDataType", value: function (e) {
